...
const Login = ({navigation, onLogin}) => {
  ...
  return (
    <View style={tw`h-full bg-indigo-50`}>
      <View
        style={tw`w-full h-[45%] flex items-center rounded-b-full bg-indigo-500 justify-center`}>
        <Image
          source={require('../public/doctor.png')}
          style={tw`h-48 w-56 rounded-b-full`}
        />
      </View>
      <View style={tw` p-10 h-[50%]  flex justify-evenly items-center`}>
        <View>
